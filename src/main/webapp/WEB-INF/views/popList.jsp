...
<%
	...
	for(InformationTO to : infoList) {
		...
		String imagename = "./upload/pimages/" + to.getImage1();
		
		
		 sbHtml.append("<div class='col mb-5'>");
		 sbHtml.append("<div class='card h-100'>");
		 sbHtml.append("<!-- Sale badge-->");
		 sbHtml.append("<div class='badge bg-dark text-white position-absolute' style='top: 0.5rem; right: 0.5rem'>Pop-Up STORE</div>");
		 ...
		 sbHtml.append("</div>");
		 sbHtml.append("</div>");
		 sbHtml.append("<!-- Product actions-->");
		 sbHtml.append("<div class='card-footer p-4 pt-0 border-top-0 bg-transparent'>");
		 sbHtml.append("<div class='text-center'><a class='btn btn-outline-dark mt-auto' href='popView.do?infoId=" + infoId +"'>View</a></div>");
		 sbHtml.append("</div>");
		 sbHtml.append("</div>");
		 sbHtml.append("</div>");
...
<html lang="en">
    <head>
        ...
        <title>Pop Up Store | popbob</title>
        <!-- Favicon-->
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="popbob.do">Home</a></li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item active" href="popList.do">Pop Up Store</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
		...
		<header class="bg-dark py-5" style="background-image: url('https://images.unsplash.com/photo-1533134486753-c833f0ed4866?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=1080&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTYzMDQzMTk4OQ&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1920'); background-size: cover;">
  			<div class="container px-4 px-lg-5 my-5">
    			<div class="text-center text-white">
      				<h1 class="display-4 fw-bolder">POP UP STORE</h1>
      					<p class="lead fw-normal text-white-50 mb-0">진행 중인 팝업스토어</p>
    			</div>
  			</div>
		</header>
        <!-- Section-->
