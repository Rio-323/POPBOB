...
ArrayList<InformationTO> infoEhbList = (ArrayList) request.getAttribute("infoEhbList");
...
String imagename1 = "./upload/eviewimages/" + infoTO.getImage2();
String imagename2 = "./upload/eviewimages/" + infoTO.getImage3();
String imagename3 = "./upload/eviewimages/" + infoTO.getImage4();

StringBuilder sbHtml = new StringBuilder();

for (InformationTO to : infoEhbList) {

	String subInfoId = to.getInfoId();
	String subTitle = to.getTitle();
	String subperiod = to.getPeriod();

	String image1 = "./upload/eimages/" + to.getImage1();
	...
	sbHtml.append("<div class='text-center'>");
	sbHtml.append(
	"<a class='btn btn-outline-dark mt-auto' href='/ehbView.do?infoId=" + subInfoId + "'>View options</a>");
	sbHtml.append("</div>");
	sbHtml.append("</div>");
	sbHtml.append("</div>");
	sbHtml.append("</div>");
...
<title>Exhibition View | popbob</title>
<!-- Favicon-->
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3d191922c66fdb09c41a4feae5ada7e0"></script>
...
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item" href="popList.do">Pop Up
									Store</a></li>
						</ul></li>
				</ul>
			</div>
		...
		<div class="container px-4 px-lg-5 my-5">
			<div class="row gx-4 gx-lg-5 align-items-center">
				...
				<div class="col-md-6">
					...
					<div class="d-flex">
						<button id="resBtn" class="btn btn-outline-dark flex-shrink-0"
							type="button">
	...
	<section class="py-5 bg-light">
		<div class="container px-4 px-lg-5 mt-5">
			<h2 class="fw-bolder mb-4">전시회 최신 목록</h2>
			<div
